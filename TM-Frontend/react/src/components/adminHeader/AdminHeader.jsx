    ...
    <div className={`${darkMode ? styles.container : styles.darkHeader}`}>
      ...
      <div className={styles.button}>
        <ul>
          ...
          <li className={location.pathname === "/admin/extensionRequests" ? styles.active : ""}>
            <Link to="/admin/extensionRequests">extensionRequests</Link>
          </li>
          <li className={location.pathname === "/admin/users" ? styles.active : ""}>
            <Link to="/admin/users">users</Link>
          </li>
          <li className={location.pathname === "/admin/createTask" ? styles.active : ""}>
            <Link to="/admin/createTask">createTask</Link>
          </li>
          <li className={location.pathname === "/admin/assignedTasks" ? styles.active : ""}>
            <Link to="/admin/assignedTasks">assignedTasks</Link>
          </li>
          <li className={location.pathname === "/admin/allTasks" ? styles.active : ""}>
