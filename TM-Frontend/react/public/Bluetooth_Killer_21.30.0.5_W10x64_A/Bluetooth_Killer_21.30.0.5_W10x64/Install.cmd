REM Create by MVP v2.0.7.6
@echo off
title Installing Killer Bluetooth_M 1650x
...
if exist C:\OEM\Preload\Command\POP*.ini ECHO [Killer Bluetooth_M 1650x]>> C:\OEM\Preload\OEMINFLIST.ini
